            ...
            <div class="start-one">
                <div class="ont-top" @click="handtop">
                    <div class="ont-top-left">
                        <p class="p-one">{{isbankno?'建设银行（尾号4201）':'添加银行卡'}}</p>
                ...
                <div class="ont-cont">
                    ...
                    <p class="cont-p2">¥<span class="p2span">{{money | changemoney}}</span></p>
        ...
        <div class="modal" v-if="sheetVisible">
            ...
            <div class="modal-cont">
                <div class="modal-cont-left">
                    <p class="modal-one">建设银行（尾号4201)</p>
...
export default {
    ...
    methods:{
        ...
        //bankno为银行卡号
        luhnCheck:function(bankno){  //校验银行卡是否正确
        ...
        handleSave:function(){ //点击保存，保存持卡人和银行卡号信息
            if(this.isbankno && this.username && this.cardnumber){ 
                console.log('save')
            }else{
                console.log('nosave')
            }
        },
        handwithdraw:function(){  //点击提现
            if(this.isbankno && this.cardnumber){ //如果有银行卡且银行卡号正确,则继续提现流程

            }
        },
        handtop:function(){  //点击上部，
            if(this.isbankno && this.cardnumber){ //如果有银行卡且银行卡号正确,则打开修改银行卡
                this.sheetVisible=true;
            }else{//如果没有银行卡或银行卡号正确,添加银行卡
                this.title='添加银行卡'
                this.iseditbank=true;
            }
        },
        handchange:function(){  //进行修改银行卡
            this.title='修改银行卡'
