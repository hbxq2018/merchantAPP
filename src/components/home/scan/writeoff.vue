<template>
  <div class="write">
    ...
    <div class="content">
        ...
        <div class="code money skuk" v-if="ticket.skuName"><span slot="left">{{ticket.skuName}}</span>  <span>-{{ticket.couponAmount}}</span></div>
    ...
    submit: function() {
      ...
      if (!this.isdiff) {
        ...
        let obj = {
          ...
          shopId: "", //商家id	Long
          shopName: "", //店铺名称	Date
          shopAmount: _ticket.shopAmount, //消费总额	BigDecimal
