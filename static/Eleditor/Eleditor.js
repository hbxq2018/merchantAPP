		...
		if( typeof WebUploader != 'undefined' && typeof _args.uploader != 'function' ){
			...
			_imageUploader.on( 'uploadSuccess', function( _file, _call ) {
			    ...
			    if( _call.code == 0 ){
					...
					if( _hasStyleBarBtn ){
						_$editorTextArea.append('<img style="max-width:100%;height:auto" src="'+_call.data.picUrl+'">');
					}else{
				    	_appendHistory();

						_$selected.after( $('<img style="max-width:100%;height:auto" src="'+_call.data.picUrl+'">') );
